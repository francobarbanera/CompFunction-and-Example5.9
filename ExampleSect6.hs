...
pv  = MkOutput ns [(hureq,pv1),(presvalreq,(MkInput ns [(presval,pv)])),(ping,(MkInput ns [(pong,pv)]))] -- The process V in the example
...
--
--
-- The first gateway obtained out of dmhp and cut at level 10 is obtained by evaluating
-- pruneproc 10 (firstofthree (gateways dmhp nh nv nw)) 
-- obtaining
-- p?te-req.p!{
--              te-rep. p?hu-req.v!hu-req.v?{
--                                            hu-rep. p!hu-rep.p?pr-req.w!pr-req.w?{
--                                                                                   pr-rep. p!pr-rep.ETC.,
--                                                                                   pr-fail. p!pr-fail.ETC.},
--                                            hu-fail. p!hu-fail.0},
--              te-fail. 0}
